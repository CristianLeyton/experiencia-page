...
export function Card({title, text, iconTime = false} : {title: string, text: string, iconTime?: boolean}) {
    return (
    <article className="bg-zinc-200 dark:bg-zinc-900 rounded-xl p-4 text-center relative hover:border-yellow-500 transition-colors duration-300 border border-secondary dark:border-primary group">
